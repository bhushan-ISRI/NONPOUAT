...
import type { ISonaNonPoProps } from "../ISonaNonPoProps";
...
export const ViewRequest = (props: ISonaNonPoProps) => {
    ...
    const loadItem = async (itemId: number) => {
        ...
        try {
            ...
            const item = await sp.web.lists
                ...
                .select("ID,Title,GLDescription,CostCenterDescription,Amount,GLCode,CostCentre,VoucherNumber,VoucherDate,RequestDate,EmployeeName,Stage,ApprovalMatrix,WorkflowHistory,Email,ContactNo,Division,Department,Location,RM,HOD,EmployeeStatus,ApprovalMatrix,VendorName,InvoiceNumber,InvoiceDate,Basicamount,GST,OtherCharges,Totalamount,WorkflowHistory,Status,PaymentRemarks,ApprovalRemarks,VendorCode/VendorCode,VendorCode/Title,VendorCode/Id,NatureofExpense/Title,NatureofExpense/ExpenseType,CurrentApprover/ID,CurrentApprover/EMail,CurrentApprover/Title")
            ...
            setVoucherDate(item.VoucherDate ? new Date(item.VoucherDate).toLocaleDateString("en-GB") : "");
    ...
    return (
        <div>
            ...
            <div className='borderedbox'>
                ...
                {(Status === "Pending for Vouching" || Status === "Closed") &&   (
                    <>
                        <div className="heading1">
                        ...
                        <div className='main-formcontainer'>
                            ...
                            <div className='row mb-20'>
                                <div className='col-md-6'>
                                    <label className='font fontblock'>Voucher Date : &nbsp;&nbsp; </label>
